    ...
    const notificationEmailHTML = `
      ...
      <head>
        ...
        <style>
          ...
          .value { background: #f9fafb; padding: 12px; border-radius: 6px; border-left: 3px solid #3b82f6; }
        ...
        <div class="container">
          ...
          <div class="content">
            ...
            <div class="field">
              ...
              <div class="value"><a href="mailto:${validatedData.email}" style="color: #3b82f6;">${validatedData.email}</a></div>
            </div>
            ${validatedData.phone ? `
            <div class="field">
              <span class="label">📞 Téléphone</span>
              <div class="value"><a href="tel:${validatedData.phone}" style="color: #3b82f6;">${validatedData.phone}</a></div>
            </div>
            ` : ''}
            <div class="field">
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p>Notre équipe va étudier votre demande et vous apportera une réponse personnalisée dans les <strong>48 heures</strong>.</p>
            
            <p>Si vous avez une question urgente, n'hésitez pas à nous contacter directement :</p>
            <ul style="list-style: none; padding: 0;">
              <li>📧 <a href="mailto:contact@formaskills.pro" style="color: #3b82f6;">contact@formaskills.pro</a></li>
